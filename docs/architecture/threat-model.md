...
| S2  | Credential stuffing or brute force              | Auth                     | Supabase rate limits, app-level limits on auth actions, MFA (TOTP)                          | Phase 3                         |
...
| D1  | Request floods                                  | edge, auth               | Vercel protections, rate limits, pagination limits                                          | Phase 3 / 22                    |
