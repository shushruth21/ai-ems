...
| Access control           | Permission catalog and role templates (`packages/security`), RLS policies with tests, MFA support                    |
...
| Audit logging            | Append-only `audit_events` (trigger-enforced)                                                                        |
